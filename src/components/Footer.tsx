    ...
    <>
      ...
      <section className="bg-secondary py-10">
        <div className="container flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/quote"
            className="bg-black text-white px-8 py-3 font-heading font-bold text-sm uppercase tracking-[0.2em] hover:bg-black/90 transition-colors shrink-0"
          >
            Get a Free Quote
          </Link>
        </div>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-white/50 text-base leading-relaxed font-body max-w-xs">
            ...
            {/* Navigation */}
            <div>
              <h4 className="font-heading font-bold text-white text-sm uppercase tracking-[0.2em] mb-6">Navigation</h4>
              <nav className="flex flex-col gap-3">
                {[
                  ...
                  <Link key={l.path} to={l.path} className="text-white/50 hover:text-primary transition-colors text-base font-body">
                    {l.label}
                  </Link>
                ))}
              </nav>
            ...
            {/* Services */}
            <div>
              <h4 className="font-heading font-bold text-white text-sm uppercase tracking-[0.2em] mb-6">Our Services</h4>
              <nav className="flex flex-col gap-3">
                {[
                  "General Building",
                  ...
                  <Link key={s} to="/services" className="text-white/50 hover:text-primary transition-colors text-base font-body">
                    {s}
                  </Link>
                ))}
              </nav>
            ...
            {/* Contact */}
            <div>
              <h4 className="font-heading font-bold text-white text-sm uppercase tracking-[0.2em] mb-6">Get In Touch</h4>
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <MapPin className="w-4 h-4 text-primary shrink-0 mt-0.5" weight="fill" />
                  <span className="text-white/50 text-base font-body">Ndola, Zambia</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-4 h-4 text-primary shrink-0" weight="fill" />
                  <a href="tel:+260974397448" className="text-white/50 text-base font-body hover:text-primary transition-colors">
                    +260 974397448
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Envelope className="w-4 h-4 text-primary shrink-0" weight="fill" />
                  <a href="mailto:info@suresafety.co.zm" className="text-white/50 text-base font-body hover:text-primary transition-colors">
              ...
              <div className="mt-8">
                <h4 className="font-heading font-bold text-white text-sm uppercase tracking-[0.2em] mb-4">Working Hours</h4>
                <div className="space-y-1.5 text-base text-white/50 font-body">
