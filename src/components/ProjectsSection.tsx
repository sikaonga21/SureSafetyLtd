...
const projects = [
  {
    ...
    description:
      "A multi-unit residential development delivered from structural shell through to exterior completion, with modern finishes and on-site safety compliance throughout.",
  },
  {
    ...
    description:
      "Full interior fit-out including bespoke kitchen areas, coordinated electrical works, and premium finishing for a corporate headquarters.",
  },
  {
    ...
    description:
      "Large-span steel warehouse erection with reinforced foundations, cladding, and integrated facility maintenance planning from day one.",
  },
  {
    ...
    description:
      "Strategic road infrastructure upgrade including sub-base preparation, surfacing, kerbing, and drainage to improve long-term durability.",
  },
];
  ...
  return (
    <section id="projects" className="py-20 lg:py-28 bg-card">
      <div className="container">
        ...
        >
          <p className="text-primary font-heading font-semibold text-sm uppercase tracking-wider mb-2">Our Portfolio</p>
              ...
              <div className="flex flex-col h-full border border-transparent hover:border-primary/20 transition-all">
                <div className="relative h-72 overflow-hidden">
                  ...
                  <div className="absolute top-0 left-0 p-6">
                    <span className="px-4 py-2 bg-primary text-black text-sm font-heading font-bold uppercase tracking-widest shadow-xl">
                      {project.category}
                    </span>
                  </div>
                </div>
                <div className="p-10 flex flex-col justify-center flex-grow">
                  <div className="flex items-center gap-2 text-primary mb-4">
                    ...
                    <span className="text-sm font-heading font-bold uppercase tracking-widest">{project.date}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-muted-foreground text-sm mb-6 uppercase tracking-wider">
                    <MapPin className="w-4 h-4" />
                    <span>{project.location}</span>
                  </div>
                  <p className="text-muted-foreground text-sm leading-relaxed mb-8 font-body">{project.description}</p>
                  <button className="flex items-center gap-2 text-primary text-sm font-heading font-bold uppercase tracking-widest hover:gap-3 transition-all mt-auto group/btn">
                    View Project{" "}
        ...
        >
          <div className="relative z-10">
            ...
            <Link
              to="/contact"
              className="inline-block bg-primary text-black px-10 py-4 font-heading font-bold text-sm uppercase tracking-widest hover:bg-white transition-all shadow-xl"
            >
