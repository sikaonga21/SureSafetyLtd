    ...
    <div className="container">
      <div className="grid md:grid-cols-3 gap-10 items-start">
        <div className="md:col-span-1">
          <p className="font-heading font-bold text-foreground text-sm uppercase tracking-[0.25em] leading-relaxed">
            Sure Safety<br />Limited
          </p>
        </div>
        <div className="md:col-span-2">
          <p className="text-muted-foreground text-base leading-relaxed font-body max-w-2xl">
...
const CareerBanner = () => (
  ...
  >
    <div className="lg:w-2/5 h-72 lg:h-auto overflow-hidden">
      <img
        src={portfolioFeatured.careersBanner}
        alt="Careers at Sure Safety Limited — build your future with us"
        className="w-full h-full object-cover"
      />
    </div>
    <div className="lg:w-3/5 px-10 py-16 lg:px-20 flex flex-col justify-center">
      <p className="text-primary font-heading font-semibold text-sm uppercase tracking-[0.3em] mb-6">
        Join Our Team
      </p>
      ...
      <p className="text-section-dark-fg/60 text-base font-body mb-10 max-w-md leading-relaxed">
      ...
      <Link
        to="/careers"
        className="inline-block border border-section-dark-fg text-section-dark-fg text-sm font-heading font-bold uppercase tracking-[0.2em] px-8 py-3.5 hover:bg-primary hover:border-primary hover:text-black transition-all duration-300 self-start"
      >
        View Opportunities
      </Link>
    </div>
