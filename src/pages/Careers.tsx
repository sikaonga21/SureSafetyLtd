                    ...
                    <div className="container">
                        ...
                        {!isLoading && jobs.length === 0 && (
                            <div className="py-16 text-center text-muted-foreground">
                                ...
                                <p className="font-heading uppercase tracking-widest text-base">
                                            ...
                                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                                                <div className="space-y-4">
                                                    <div className="flex flex-wrap items-center gap-4">
                                                        ...
                                                        <span className="px-3 py-1 bg-primary/10 text-primary text-xs font-heading font-bold uppercase tracking-widest">
                                                            {job.type}
                                                        </span>
                                                    </div>
                                                    <div className="flex flex-wrap gap-6 text-xs text-muted-foreground font-heading font-bold uppercase tracking-widest">
                                                ...
                                                <Link
                                                    to="/contact"
                                                    className="bg-primary text-black font-heading font-bold text-sm uppercase tracking-[0.2em] px-10 py-4 hover:bg-black hover:text-primary transition-all flex items-center gap-2 shrink-0 self-start md:self-center shadow-lg"
                                                >
